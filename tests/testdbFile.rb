    ...
    json.each do |spell, value|
        value.each do |ext|
            ...
            ext["changes"].each do |change|
                ...
                when "system.AsPCost.value", "defenseMalus", "system.castingTime.value", "decreaseCastingTime.mod", "spellRollModifiersreduceCostSpell.mod", "increaseRangeSpell.mod", "reduceCostSpell.mod"
