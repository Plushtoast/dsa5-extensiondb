    ...
    json.each do |spell, value|
        value.each do |ext|
            ...
            ext["changes"].each do |change|
                ...
                when "system.AsPCost.value", "defenseMalus", "system.castingTime.value", "spellRollModifiers.decreaseCastingTime.mod", "spellRollModifiersreduceCostSpell.mod", "spellRollModifiers.increaseRangeSpell.mod", "spellRollModifiers.reduceCostSpell.mod"
