...
const dict = {
  de: {
    ...
    infoText:
      "Der Zauberer kann ein alchimistisches Elixier verdünnen, sodass daraus zwei Elixiere werden. Diese weisen jeweils eine um 3 niedrigere QS auf. Fällt die QS auf 0 oder weniger, scheitert die Verdünnung und das Elixier wird unbrauchbar.",
  ...
  en: {
    ...
    infoText:
      "The caster can dilute an alchemical elixir, creating two elixirs. Each has 3 lower QL. If QL drops to 0 or below, the dilution fails and the elixir becomes unusable.",
