...
const dict = {
  de: {
    ...
    qs1TextItem: (itemName) => `Bei dem Erzeugnis handelt es sich um ${itemName}.`,
    qs2TextItemQs: (itemName, qs) => `Bei dem Erzeugnis handelt es sich um ${itemName} der Qualitätsstufe ${qs}.`,
  ...
  en: {
    ...
    qs1TextItem: (itemName) => `The concoction is ${itemName}.`,
    qs2TextItemQs: (itemName, qs) => `The concoction is ${itemName} of quality level ${qs}.`,
