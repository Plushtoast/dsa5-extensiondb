...
const dict = {
  ...
  en: {
    ...
    infoText: "The caster can dilute an alchemical elixir, creating two elixirs. Each has 2 lower QS. If QS drops to 0 or below, the dilution fails and the elixir becomes unusable.",
