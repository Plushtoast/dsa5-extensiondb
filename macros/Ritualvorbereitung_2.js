...
const injection = `
  effects: [{
    name: (typeof elData !== "undefined" ? elData.label : dict.itemName),
    img: "icons/svg/aura.svg",
    transfer: true,
    changes: [
      { key: "system.skillModifiers.FP", mode: 0, value: "Elementarer Diener 2, Dschinnenruf 2, Meister der Elemente 2" }
    ]
  }],
`;
